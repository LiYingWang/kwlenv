...
The sampled faunal assemblage from the major residential area at Kiwulan suggests a continuation of sika deer consumption since CL6 until CL2, and then shifted to cattle in CL1. Despite deer had been a substantial part of dietary practices at Kiwulan, variations in their quantity, ubiquity, butchering patterns, and proportions relative to other animals shows changes that could reflect the indigenous reactions to foreign presence. Based on radiocarbon dates and diagnostic artifacts indicating specific time [@Wang2020ornament; @Chen2007], the cultural layers were further grouped into temporal sequences relative to foreign presences for the following discussion. The sequences include the pre-European period (CL6, CL5), the European period (CL4), post-European period (CL3), and the arrival of Han-Chinese immigrants (CL2, CL1). It should be noted that the European period does not necessary means a solid European colonial control over the Kiwulan, but a broad impacts from European occupation and economic activities on indigenous societies in Yilan, such as getting involvement into the long-distance trade network, being part of the tribute system, or experiences of occasional European attacks. 

<!--summary of overall observations-->
Faunal remains recovered from the layer associated with the European presence reveal the highest quantity, followed by the pre-European period. During the European period, in addition to the predominance of deer, an increased proportion of suid among faunal remains suggests a slightly greater reliance on suid as a secondary meat source compared to other time periods, along with a broader range of medium and small animals, such as muntjac, birds, fish, and reptiles. A similar pattern was observed in the ubiquity of animals, which shows the highest ubiquity of deer, suid, and munjact remains during the European period. Interestingly, deer bones from the pre-European period, specifically CL5, presented the same ubiquity as in the European period but in only half the quantity. This might indicate consistency in the frequency and distribution of deer at the settlement scale before and after European presence, but consumption of deer was intensified during the European period. During the Chinese period, the low quantity of deer in CL2 and the predominate of cattle in CL1 suggest a sudden shift in dietary practices after the Chinese arrival, indicating a Chinese influence and the decline of Indigenous population in this region.

<!--key results of skeletal part frequencies and butchery patterns-->
The skeletal part frequencies and butchery patterns of deer demonstrate more complete carcasses processed within the settlement during the European period and pre-European period compared to the post-European period and Chinese period. Although a more complete and evenly distributed deer parts with cut marks were found in both the European period and before European arrival, the substantial rise in head parts (e.g., crania and mandibles) and overall high quantity of bones in the European period suggests more deer were brought back intact to the settlement. The low frequency of head parts in the earliest layer and Chinese period might indicate deer could be mostly processed at the hunting location with only meaty (e.g., upper limb) and mid-meaty portions (e.g., ribs) selectively butchered and transported back. Interestingly, among the meaty portions throughout all periods, front quarters (e.g., humeri, radius) are more frequently found compared to forequarters (e.g., femur, tibia). One likely explanation is that femur and tibia might be heavily fragmented due to being broken for their high marrow yields [@Madrigal2002], leading to underestimation due to difficult identification. The behavior of marrow extraction can be supported by around one-third long bones being fractured and a moderate degree of fragmentation on average at Kiwulan. Another possibility is forequarters could be traded since deer legs as commodity were mentioned in European records [@Blusse2006, pp.220-224], but unfortunately, there was no detail about which portion of legs were normally traded. 

<!--skinning-->
The cut marks found on the lower limbs of deer at Kiwulan should be associated with the traces left by skinning processes, which confirms that deer skins were removed and likely used for trading with external traders. A large quantity of foreign goods, such as ornaments, porcelains, and metal items, supports frequent trading activities between Kiwulan residents and outsiders [@Wang2020ornament; @Chen2007]. Deer hides and venison, were important commodities in the East Asian trade network since the mid-15th century, connecting Han Chinese, Japanese, and Indigenous people, especially in western Taiwan [@Cheng2017; @Hollmann1991]. This deer trade was later monopolized by the Europeans in the 17th century, and deer products were largely exported to Japan. The evidence of the removal of deer skins at Kiwulan suggests that not only western Taiwan but also northeastern Taiwan involved and impacted by the long-distance trade. Deer bones with skinning cuts did not show a substantial increase in the European period; however, the disproportionate increase in head parts hints at a likelihood of brain tanning when preparing hides. Brain tanning is a traditional method for softening and preserving hides commonly used in many Indigenous cultures, such as North America, Southern Africa, North Asia, and Japan [@Baillargeon2010; @Badenhorst2009; @Hatt1969; @Matsumoto2016]. The present-day Bunun group in the central highlands of Taiwan has revived hide tanning based on oral history, primarily using peanuts or pig lard, with a few examples using animal brains [@Li1999, pp. 48; @Xu1994]. Although materials for tanning used by the Kavalan people are unknown due to the loss of traditions, brain tanning is a possible method given the availability of animal brains from hunting and their high-fat content. 

<!--decline of deer, ceramics, and population dynamics of Kiwulan-->
The dramatic decrease in deer bones during the Chinese period may indicate overhunting that persisted for centuries or a decline in the Indigenous population (Zhan, 1995). The double increase in suid after the European arrival may suggest an increased reliance on pigs. This implies that pigs played a more significant role in the diet after Europeans arrived. Eventually, cows replaced pigs during the Chinese period, which might be a Chinese influence.
