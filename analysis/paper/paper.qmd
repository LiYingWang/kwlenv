---
title: "Exploring colonial impacts on indigenous hunting and animal use in northeastern Taiwan"
author:
  - Li-Ying Wang:
      correspondence: "yes"
...
The sampled faunal assemblage from the major residential area at Kiwulan suggests a continuation of sika deer consumption from CL6 to CL2, and then shifted to cattle in CL1. Despite deer was a substantial part of dietary practices at Kiwulan, variations in their quantity, ubiquity, butchering patterns, and proportions relative to other animals show changes that could reflect the indigenous reactions to foreign presence. Based on radiocarbon dates and diagnostic artifacts indicating specific time [@Wang2020ornament; @Chen2007], the cultural layers were further grouped into temporal sequences in relation to foreign presences for further discussion. The temporal sequences include the pre-European period (CL6, CL5), the European period (CL4), the post-European period (CL3), and the arrival of Han-Chinese immigrants (CL2, CL1). It should be noted that the European period does not necessarily mean a solid European colonial control over the Kiwulan, but a broad impact from European occupation in Northern Taiwan and associated colonial activities on indigenous societies in Yilan, such as getting involved in the long-distance trade network, being part of the tribute system, and experiencing occasional European attacks. 

<!--summary of overall observations across time periods -->
Faunal remains recovered from the European period reveal the highest quantity, followed by the late pre-European period. During the European period, in addition to the predominance of deer, an increased proportion of suid suggests a slightly greater reliance on suid as a secondary meat source. A similar pattern was observed from a higher ubiquity of suids during the European period compared to other periods. Interestingly, deer bones from the late pre-European period presented the same ubiquity as in the European period but in only half the quantity. This might indicate consistency in the frequency and distribution of deer at the settlement scale before and after European presence, but deer utilization was intensified during the European period. The dramatic decrease in deer bones after the European period might be related to both the decline of the Kiwulan population and a decrease in the wild deer population. Sika deer populations in western Taiwan have significantly shrunk since the 18th century because of habitat loss and overhunting [@Chen2000animal]. Despite this, deer remained a predominant resource for local consumption at Kiwulan during the post-European and early Chinese period. In the late Chinese period, the dietary preference shifts from deer to cattle, suggesting a Chinese influence and the relocation of the Kavalan people to Hualien due to population pressures from Chinese immigration [@Zhan1995]. 

<!--skeletal part frequencies and butchery patterns of deer-->
Despite being the main resource throughout most periods, deer utilization shows different patterns over time. Dear body parts and butchery patterns demonstrate more complete carcasses processed within the settlement during the European and pre-European period compared to the post-European and Chinese period. Although more complete and evenly distributed joints with cut marks were found in both the European period and before the European arrival, the substantial rise in head parts (e.g., crania and mandibles) with the overall high quantity suggests more deer were brought back intact to the settlement. On the contrary, the low frequency of head parts in the early pre-European period and Chinese period might indicate deer could be mostly processed at the hunting location with mostly meaty (e.g., upper limb) and mid-meaty portions (e.g., ribs) selectively butchered and transported back. Interestingly, among the meaty portions, front quarters (e.g., humeri, radius) are more frequently found compared to forequarters (e.g., femur, tibia) throughout all periods. One likely explanation is that femur and tibia might be heavily fragmented due to being broken for their high marrow yields [@Madrigal2002], leading to underestimation due to difficult identification. Marrow extraction at Kiwulan can be supported by around one-third of long bones being fractured and a moderate degree of fragmentation on average. Another possibility is forequarters could be traded since deer legs and meats as commodities were commonly mentioned in European records [@Blusse2006, pp.220-224], but there is no mention of any specific legs commonly traded. Considering the generally high frequencies of meaty portions found at Kiwulan, deer might not just for consumption at the site, but also for trading.

<!--deer hides-->
Deer hides were important commodities since the mid-15th century, connecting Han Chinese, Japanese, and Indigenous people, and later monopolized by the Europeans in the 17th century, when deer products were largely exported to Japan, especially from western Taiwan [@Cheng2017; @Hollmann1991]. The cut marks found on the lower limbs of deer at Kiwulan should be associated with the traces left by skinning, which confirms the removalof  deer skins and likely being traded with external traders. A large quantity of foreign goods, such as ornaments, porcelains, and metal items, supports frequent exchange between Kiwulan residents and outsiders [@Wang2020ornament; @Chen2007]. The evidence of skinning and foreign goods at Kiwulan suggests that not only western Taiwan but also northeastern Taiwan was involved and impacted by the long-distance trade. Although deer bones with skinning cuts did not show a substantial increase in the European period, the disproportionate increase in head parts might hint at a likelihood of brain tanning when preparing hides. Brain tanning is a traditional method for softening and preserving hides commonly used in many Indigenous cultures, such as North America, Southern Africa, North Asia, and Japan [@Baillargeon2010; @Badenhorst2009; @Hatt1969; @Matsumoto2016]. The present-day Bunun group in the central highlands of Taiwan has revived hide tanning based on oral history, primarily using peanuts or pig lard, with a few examples using animal brains [@Li1999, pp. 48; @Xu1994]. Despite the materials for tanning used by the Kavalan people being unknown due to the loss of traditions, brain tanning is a practicable method given the availability of deer brains from hunting. 

<!-- population dynamics and arguments-->
The population dynamics at Kiwulan must be considered when discussing faunal changes over time. A larger pottery vessels during the European period suggests population growth [@Wang2020pot; @Hsieh2009], which may contribute to the increasing animal consumption overall. However, the impacts from foreign presence on faunal assemblages can be revealed through butchery patterns of deer parts, the relative proportions of animals, and taxon ubiquity. First, deer bones with skinning evidence were mostly found during the European period, followed by the late pre-European phase, corresponding with the rise of regional trade networks since the 15th century and intensified in the 17th century. Second, if the high frequency of deer head parts during the European period solely resulted from food scarcity due to population growth and increased consumption of brains for nutrition, a parallel rise in marrow extraction would be expected. However, fractured long bones did not increase during the European period or the previous phase; instead, they were 10-30 % lower than in other periods. Third, population growth should have led to a more proportional increase in both large and small animals. Although there was a high taxonomic diversity during the European period, suids present a disproportionate rise in their ubiquity, quantity, and proportion compared to other animals. This suggests that intensified deer hunting for trade may have driven indigenous people to rely more on suids as an alternative prey, likely due to their comparable body size and meat return rates to deer [@Broughton2011prey]. Suids as a secondary protein source after deer is also observed in prehistoric western Taiwan [@Chuang2021]. 

<!--indigenous reaction and resilience-->
Compelling the results of faunal analysis and reports from historical records, the substantial increase in deer bones in the European period not just simply the result of population growth, but also a shift driven by European presence and associated intensified long-distance trade. It is clear to see deer is both the first priority of food source and commodities at Kiwulan since the late pre-European period and intensified during the European period. Based on the dietary preference, the increased use of suids during the European period could be a temporary subsistence strategy in response to the high demands of deer products. After the Europeans left, deer hide trade continued but on a smaller scale, with around 10,000 hides exported annually in the 18th century, which is 20 times less than during the European period [@]. This change likely reduced the reliance of suids, as shown by their decreased proportion at Kiwulan. The slightly increase in muntjact during the post-European and early Chinese period might be associated with the decline of deer population, leading people turned to use muntjact hides for trade instead []. Nevertheless, deer continued to be consumed until the early Chinese period. Everyday practices play an essential role for connecting history and social memories, enabling Indigenous people maintain tradition in a setting of frequent cultural exchange or asymmetrical relations [@Silliman2009; e.g., @Noe2023]. The persistence of deer consumption at Kiwulan reflect identity negotiation and tradition maintenance, while the increased utilization of suids likely responded to the high demand for deer products in large scale trade. This highlights how Kiwulan residents reacted to foreign presence and demonstrated cultural resilience. 

<!--taphonomic & preservation bias -->
