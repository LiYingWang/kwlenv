...
Surface modifications, including cut marks, fractures, and burning damage, were identified on deer bones from CL6 to CL2, with variations in their proportions (@tbl-deer-modify). Burned bones, characterized by charring and color changes, had the highest proportion in CL6 at 40% and gradually decreased to less than 10% after CL4. Cut marks were present on 50% of bones in CL2, 30% of bones in earlier period (CL6 to CL4), and at a lower proportion of 23% in CL3. Most cut marks were located on major limb joints and long bones, suggesting butchering activities related to disarticulation and meat detaching. @fig-deer-cutmark shows that at least 50 % of joints of each deer part in CL4 present cut marks, with a higher proportion of 75% at the hip. A similar pattern was observed in CL5, but with a lower proportion of cut marks on the ankle, knee, and hip compared to CL4. Not all joints were found in CL6, CL3 and CL2, making direct comparisons across all layers difficult. Nevertheless, the overall high proprotion of joints with cut marks suggests intensive proceessing of deer throughout the site's occupation. Cut marks on lower limbs can be associeted with skinning and were primarily found on metapodials in CL6 (n = 1), CL5 (n = 4), CL4 (n = 6), CL3 (n = 1), followed by first phalanges in CL4 (n = 1) and CL5 (n = 1).

Bone breakage patterns, including spiral fractures, transverse fractures, longitudinal splits, percurssion scars, and chop marks [@Haynes1983; @Gifford2018; @Fisher1995], were observed esepically on long bones across different layers. These fractures indicate intentional marrow extraction at Kiwulan. CL2 had the highest proportion of fractured bones (> 50%), compared to 35% in CL3 and CL6, and 25% in CL4 and CL5. This suggests more intensive marrow extraction in later periods. Most chop and cut marks were likly made by metal tools according to clean, smooth cut surfaces and finer marks on bones. The use of metal tools can be further supported by the finding of iron knives at Kiwulan [@Chen2007]. In addition to anthropogenic modifications, natural alterations to bones resulting from post-deposition impacts, such as weathering and root etching [@Gifford2018natural], were identified on approximately one-third of the bones across all layers (@tbl-deer-modify). 
