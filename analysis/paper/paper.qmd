...
To explore changes in resource use before and after the European arrival with associated long-distance trade, I analyzed zooarchaeological and botanical assemblages from 40 adjacent units at the residential area excavated during the first season (2001-2004) at Kiwulan [@Chen2007]. These 40 units were selected based on their relatively intact archaeological contexts and spatial continuity, providing a consistent framework for understanding daily food practices throughout different time periods on a settlement scale. 

To construct a reliable chronology, the archaeological records were divided into six temporal layers spanning from the 14th century to the 19th century based on excavation depth, stratigraphic data, sediment color, radiocarbon dates, and archaeological diagnostic materials that served as time indicators. These diagnostic materials include stoneware commonly found at European associated sites in early 17th-century Southeast Asia, such as Anping jars and martavan [@Sakai2012; @Ketel2011; @Dizon2016; @Hsieh1995; @Lee2021], pipes, and Chinese bricks [@Wang2011; @Hsieh2009]. Although precisely identifying the stratum representing the European arrival is challenging due to its short duration, the separation of strata into six layers based on the criteria mentioned above still provides a feasible framework for analyzing archaeological records before and after the European influence. Among these six temporal layers, the fourth layer can be associated with the 17th century, when the Europeans occupied northern Taiwan, while the second layer corresponds to the 19th century, associated with Chinese migrants.

In this study, only the faunal assemblages identified to at least the family level were considered for consistent comparison across time sequences. To obtain a general pattern of resource use, measures of ubiquity and taxonomic abundance were applied. Ubiquity measures the frequency of specific taxa through their presence or absence in particular depositional contexts, suggesting the regularity of animal consumption [@Mckechnie2016; @Vanderwarker2010]. In this analysis, ubiquity values are expressed as the percentage of units with a given taxon to the total number of units containing cultural layers. Taxonomic abundance was quantified using the Number of Identified Specimens (NISP) method for a broad overview of taxa through time [@Grayson2004; @Lyman2012]. For botanical assemblages, their number was served as supplementary evidence for food practices due to potential biases that caused by differential preservation conditions. For example, carbonized seeds usually preserve better than uncarbonized ones, which could lead to a misleading interpretation.
