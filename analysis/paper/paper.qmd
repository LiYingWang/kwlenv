...
Bovines were present in small numbers (yellow cattle) in the pre-European period but became the only animal (water buffalo) in the late Chinese period (CL1). One possible explanation for the shift in the animal taxonomic structure from deer to bovines is the dramatic decline of the Indigenous Kavalan population in Yilan during the 19th century, around the same time as a large influx of Han Chinese immigrants. Competition over land between the two groups eventually led to several waves of Kavalan relocation to eastern Taiwan, leaving only a small number of Kavalan in Yilan [@Zhan1995]. Furthermore, bovines were absent in prehistoric Taiwan and are believed to have been introduced by Han populations during the historical period [@Chen2000animal]. The reliance on bovines in CL1 may indicate both a decline in the Indigenous population and a shift from traditional hunting to livestock use introduced or intensified under Han influence. A similar cultural change is also observed in burial practices at Kiwulan, where coffin-like containers, typical funerary traditions of Han Chinese, were first adopted by Indigenous people in the late period (CL1 and CL2) [@Chen2007; @Chiu2004]. 
